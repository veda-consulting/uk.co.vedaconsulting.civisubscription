{*
 ...
 +--------------------------------------------------------------------+
*}
{* this template is used for updating subscription payment*}
<div class="crm-block crm-form-block crm-subscription-payment-form-block">
    ...
    <tr>
      ...
      <td class="form-layout">
        ...
        {if !$subscriptionPayment}
          <a href="#" class="crm-hover-button action-item adjust-subscription-payment">
...
{literal}
  <script type="text/javascript">
    CRM.$(function($) {
      ...
      $('a.adjust-subscription-payment').click(function(e) {
        e.preventDefault();
        $(this).hide();
