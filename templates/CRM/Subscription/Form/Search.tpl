...
<div id="searchForm">
    {strip}
        ...
        {include file="CRM/Subscription/Form/Search/Common.tpl"}
...
{if $rowsEmpty}
  ...
  {include file="CRM/Subscription/Form/Search/EmptyResults.tpl"}
  </div>
{/if}
  ...
  <div class="crm-results-block">
    ...
    {* Search request has returned 1 or more matching rows. *}
     ...
     <div class="crm-search-results">
       {include file="CRM/Subscription/Form/Selector.tpl" context="Search"}
       </div>
