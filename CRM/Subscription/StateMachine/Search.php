 ...
 * @copyright CiviCRM LLC (c) 2004-2016
 */
class CRM_Subscription_StateMachine_Search extends CRM_Core_StateMachine {
  ...
  public function __construct($controller, $action = CRM_Core_Action::NONE) {
    ...
    $this->_pages['CRM_Subscription_Form_Search'] = NULL;
    ...
    if ($result) {
      $this->_pages['CRM_Subscription_Form_Task_Result'] = NULL;
    }
  ...
  public function taskName($controller, $formName = 'Search') {
    ...
    return CRM_Subscription_Task::getTask($value);
  }
