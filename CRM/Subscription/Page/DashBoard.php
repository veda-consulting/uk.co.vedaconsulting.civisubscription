...
/**
 * This page is for the Subscription Dashboard.
 */
class CRM_Subscription_Page_DashBoard extends CRM_Core_Page {
  ...
  public function preProcess() {
    CRM_Utils_System::setTitle(ts('CiviSubscription'));
    ...
    foreach ($prefixes as $prefix) {
      ...
      foreach ($status as $s) {
        ${$aName}[str_replace(" ", "", $s)] = CRM_Subscription_BAO_Subscription::getTotalAmountAndCount($s, $$startName, $$endName);
      }
  ...
  public function run() {
    ...
    $controller = new CRM_Core_Controller_Simple('CRM_Subscription_Form_Search',
      ts('Subscription'),
      NULL
    );
