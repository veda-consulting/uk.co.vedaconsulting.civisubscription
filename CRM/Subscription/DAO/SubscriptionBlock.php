 ...
 * @copyright CiviCRM LLC (c) 2004-2016
 *
 * Generated from xml/schema/CRM/Subscription/SubscriptionBlock.xml
 * DO NOT EDIT.  Generated by CRM_Core_CodeGen
 * (GenCodeChecksum:884b8af4af4d96ca57a59d3bfe2d0634)
 */
require_once 'CRM/Core/DAO.php';
require_once 'CRM/Utils/Type.php';
class CRM_Subscription_DAO_SubscriptionBlock extends CRM_Core_DAO {
  /**
   * static instance to hold the table name
   *
   * @var string
   */
  static $_tableName = 'civicrm_subscription_block';
  /**
  ...
  public $id;
  /**
   * physical tablename for entity being joined to subscription, e.g. civicrm_contact
   *
   * @var string
   */
  public $entity_table;
   ...
   * @var string
   */
  public $subscription_frequency_unit;
  /**
   * Is frequency interval exposed on the contribution form.
   *
   * @var boolean
   */
  public $is_subscription_interval;
  /**
   ...
   * @var boolean
   */
  public $is_subscription_start_date_visible;
  /**
   * If true - recurring start date is editable.
   *
   * @var boolean
   */
  public $is_subscription_start_date_editable;
  /**
   * class constructor
   *
   * @return civicrm_subscription_block
   */
  function __construct() {
    $this->__table = 'civicrm_subscription_block';
    parent::__construct();
  }
  /**
    ...
    if (!isset(Civi::$statics[__CLASS__]['fields'])) {
      Civi::$statics[__CLASS__]['fields'] = array(
        'id' => array(
          ...
          'title' => ts('Subscription Block ID') ,
        ...
        'entity_table' => array(
          ...
          'description' => 'physical tablename for entity being joined to subscription, e.g. civicrm_contact',
          'maxlength' => 64,
        ...
        'is_subscription_interval' => array(
          'name' => 'is_subscription_interval',
        ...
        'is_subscription_start_date_visible' => array(
          'name' => 'is_subscription_start_date_visible',
          'type' => CRM_Utils_Type::T_BOOLEAN,
          'title' => ts('Show Recurring Donation Start Date?') ,
          'description' => 'If true - recurring start date is shown.',
          'required' => true,
        ) ,
        'is_subscription_start_date_editable' => array(
          'name' => 'is_subscription_start_date_editable',
          'type' => CRM_Utils_Type::T_BOOLEAN,
  ...
  static function &import($prefix = false) {
    $r = CRM_Core_DAO_AllCoreTables::getImports(__CLASS__, 'subscription_block', $prefix, array());
    return $r;
  }
  /**
  ...
  static function &export($prefix = false) {
    $r = CRM_Core_DAO_AllCoreTables::getExports(__CLASS__, 'subscription_block', $prefix, array());
    return $r;
  }
}
