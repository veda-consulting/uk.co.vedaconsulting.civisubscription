 ...
 */
class CRM_Civisubscription_Upgrader_Base {
  ...
  static public function instance() {
    if (! self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_Civisubscription_Upgrader(
   ...
   *
   * @code
   * CRM_Civisubscription_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
